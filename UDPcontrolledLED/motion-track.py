...
window_on = True # False    # Set to True displays opencv windows (GUI desktop reqd)
...
def motion_track():
    ...
    while still_scanning:
        ...
        if motion_found:
            ...
            # send UDP message
            MESSAGE = "000" + str(LED_COUNT - int(round((LED_COUNT * x ) / CAMERA_WIDTH ,0))) + "R00255G00000B00000"
