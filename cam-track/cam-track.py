...
"""
cam-track ver 0.72 written by Claude Pageau pageauc@gmail.com
...
MAX_SEARCH_THRESHOLD = .95  # default=.97 Accuracy for best search result of search_rect in stream images
...
def cam_shift():
    ...
    cam_cx1 = sw_cx    # Set Cam x center start position
    cam_cy1 = sw_cy    # Set Cam y center start position
    cam_cur_cx = cam_cx1 
    cam_cur_cy = cam_cy1
    cam_track_cx = 0   # initialize cam horizontal movement tracker
    cam_track_cy = 0   # initialize cam vertical movement tracker
