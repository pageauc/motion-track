...
"""
cam-track ver 0.6 written by Claude Pageau pageauc@gmail.com
...
print("Track camera pan/tilt movements optically using openCV2")
...
def cam_shift():
    ...
    sw_x = (sw_cx - sw_w/2)  # top x corner of rect
    sw_y = (sw_cy - sw_h/2)  # top y corner of rect
    sw_maxLoc = .94    # Accuracy of search in image
    sw_minVal = .45    # Lowest accuracy of search in image
    
    # take first frame of the video and initialize search rect
    cam_cx1 = sw_cx
    cam_cy1 = sw_cy
    cam_cur_cx = cam_cx1
    cam_cur_cy = cam_cy1
